...
> 문서 동기화 기준 (2026-07-19)
> - 현재 배포 기준 버전: v3.8.9.29 (2026-07-19)
> - 안정화 기준선: v3.8.9.28 (코인 우선 1단계, 학습/로그/fallback 정합)
> - 최신 변경 상세: CHANGELOG.md
> - 최신 운영 패치: 다중 거래소 컨텍스트 분리 + AI 커스텀 승인/실행검증 상태머신 + 신규사용자 제한 운용(2026-07-19)
...
- **비용 절감**: 캐싱 시스템과 조건부 호출로 최적화
- **성능 향상**: API 기반 분석으로 WebSocket 의존성 제거
...
**참고 문서**: `docs/ALPHA_ARENA_MODE.md`, `docs/USER_GUIDE.md` (Alpha Arena 섹션)
