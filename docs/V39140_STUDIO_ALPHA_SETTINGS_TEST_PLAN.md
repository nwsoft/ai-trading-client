...
기준일 2026-09-19. 소스 후보 **3.9.1.40**, updater **3.9.140**.
현재 공개 stable/latest는 **v3.9.1.39** (GitHub 조회 확인). v39 자산은 교체하지 않습니다.
...
- [ ] Windows x64 엔진 + x86 키움 호스트 + Electron v40 설치기 신규 빌드.
- [ ] PE 수치/문자 버전 3.9.1.40, updater 3.9.140, fingerprint·SHA 일치.
- [ ] 설치본 Strategy Studio 1280×800/1600×1000 및 Windows 배율 100/125/150% 확인.
- [ ] 전용 키 명시적 점검(비용 고지), Binance PAPER 시작/정지/설정 변경/재시작 확인.
- [ ] v39 → v40 업데이트, 안전 종료 및 데이터 보존 확인.
- [ ] stable/latest·목록 첫 항목·latest.yml·설치기 원격 해시 확인.
