## 현재 v3.9.1.46 소스 후보 / 공개 v3.9.1.45

v46은 기관별 시작·보호주문·전략 귀속·알림 진단 수정이며 미배포입니다. [실제 검증 경계](../reports/v39145-cross-venue-feedback-audit-20260923.md). 아래 이전 후보 문구는 작성 당시 이력입니다.
