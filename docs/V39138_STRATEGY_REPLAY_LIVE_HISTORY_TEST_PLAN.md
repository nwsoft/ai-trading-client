...
> 공개 상태 갱신(2026-09-18 확인): v3.9.1.38은 2026-09-17 GitHub stable/latest로 설치기·blockmap·`latest.yml`·`release-manifest.json`이 게시됐습니다. 아래 미완료/후보 표기는 게시 전 당시 기록이며, 실계정·특수 Windows 환경·장시간 운용의 별도 검증 경계는 계속 유효합니다.
