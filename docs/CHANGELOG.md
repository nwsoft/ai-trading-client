## 2026-07-30 - v3.9.0.4 AI 커스텀 역할·단일 후보 계약
...
## 2026-07-30 - v3.9.0.4 TP/SL 프리셋 단위 계약 교정
...
- 당시 전체 자동 회귀 `1,200 passed, 6 skipped` (최신 v3.9.0.4 결과는 `1,219 passed, 6 skipped`)

## 2026-07-29 - v3.9.0.4 설정 정본·실행 모드·페이퍼 안전성 정합화
...
- v3.9.0.3 후보에서 API 키의 운영체제 보안 저장소 이전을 도입했으나 v3.9.0.4 정책 감사에서 철회
...
- v3.9.0.2는 이전 Windows 배포본이며, 최신 manifest 상태는 pending_windows_rebuild 기준으로 관리합니다.
