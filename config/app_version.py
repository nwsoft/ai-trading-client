...
RELEASE_VERSION = "3.9.1.44"
PUBLIC_RELEASE_VERSION = "3.9.1.43"
RELEASE_DATE = "2026-09-21"
RELEASE_HIGHLIGHT = "학습·XAI 증거 보존형 저장소 및 공통 이벤트·로그 유지관리 개선"
RELEASE_PATCH = "Evidence Preserving Storage and Event Contract Patch"
...
RELEASE_NOTICE_ID = "v3.9.1.44-evidence-storage-event-contract-patch"
