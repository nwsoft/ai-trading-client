...
RELEASE_VERSION = "3.9.1.46"
PUBLIC_RELEASE_VERSION = "3.9.1.45"
RELEASE_DATE = "2026-09-23"
RELEASE_HIGHLIGHT = "기관별 관찰 시작·전략 귀속·보호주문 계약 및 알림 진단 보강"
RELEASE_PATCH = "Runtime Boundary and Protection Contract Patch"
...
RELEASE_NOTICE_ID = "v3.9.1.46-runtime-boundary-protection-contract-patch"
