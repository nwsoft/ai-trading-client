...
RELEASE_VERSION = "3.9.1.40"
PUBLIC_RELEASE_VERSION = "3.9.1.39"
RELEASE_DATE = "2026-09-19"
RELEASE_HIGHLIGHT = "전략 스튜디오 가독성·AlphaArena 안전성·설정 점검 개선"
RELEASE_PATCH = "Strategy Studio Readability and AlphaArena Safety Patch"
...
RELEASE_NOTICE_ID = "v3.9.1.40-studio-readability-alpha-safety-patch"
