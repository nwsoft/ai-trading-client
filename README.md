...
현재 공개 버전: **v3.9.1.45** · updater **3.9.145** · 사용자 배포 확인 기준.
현재 공개 기반: v3.9.1.45. 서버 배포와 Client 설치본 검증은 구분합니다.

v46 후보 패치명: Runtime Boundary and Protection Contract Patch.

현재 소스 후보: v3.9.1.46 · updater **3.9.146**. v45 이후 수정본이며 미배포입니다. [공통 경계 수정/시험](reports/v39145-cross-venue-feedback-audit-20260923.md). 설치기 빌드·실기관/Windows 검증은 별도입니다.

저장소·공통 이벤트 변경은 [v44 계획](docs/V39144_STORAGE_TEST_PLAN.md)과 [검증 보고](reports/v39144-storage-verification.md)를 확인합니다. 이 작업은 설치기 빌드·공개 릴리스를 실행하지 않으며 기존 deploy 매니페스트·해시·설치기를 덮어쓰지 않습니다.
