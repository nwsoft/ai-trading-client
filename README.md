...
현재 공개 버전: **v3.9.1.41** · updater **3.9.141** · 공개 자산은 이번 작업에서 변경하지 않습니다.
현재 공개 기반: v3.9.1.41 stable/latest. 서버 배포와 Client 설치본 검증은 구분합니다.

현재 소스 후보: v3.9.1.42 · updater **3.9.142** · Remote Operation Consent and Control Patch.
