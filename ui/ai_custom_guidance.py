"""Strategy Studio 화면·어시스턴트·메뉴얼이 공유하는 사용자 안내 정본."""
...
AI_CUSTOM_PROVIDER_GUIDE: Tuple[str, ...] = (
    ...
    "DeepSeek: V4 Flash/Pro는 텍스트·JSON, 별도 V4 Flash Vision Exp는 이미지 입력을 지원합니다. 음성 전사는 OpenAI 전용입니다.",
...
def build_ai_custom_safe_flow_compact() -> str:
    ...
    return (
        ...
        "버전 저장·승인·과거 재생 또는 비대상 확인 → PAPER 전진검증 → 사용자 최종 적용 후 제한 LIVE"
    )
