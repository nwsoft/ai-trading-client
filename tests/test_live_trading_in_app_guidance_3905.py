...
def test_fix_patch_build_is_identifiable_inside_client():
    ...
    assert RELEASE_BUILD_LABEL == "v3.9.0.8 AI Custom Update"
    assert "AI Custom Update" in DASHBOARD_TITLE
    assert "AI Custom Update" in USER_MANUAL_TITLE
    assert "ai-custom-p1-p3-source-candidate" in RELEASE_NOTICE_ID
