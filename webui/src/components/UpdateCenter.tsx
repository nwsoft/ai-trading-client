...
export function UpdateCenter({ client, onOpenGuide, detailed = false, currentVersion = "v3.9.1.43", accountScope = "" }: { client?: GatewayClient; onOpenGuide?: () => void; detailed?: boolean; currentVersion?: string; accountScope?: string } = {}) {
