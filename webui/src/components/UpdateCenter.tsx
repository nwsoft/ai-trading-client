...
export function UpdateCenter({ client, onOpenGuide, detailed = false, currentVersion = "v3.9.1.37", accountScope = "" }: { client?: GatewayClient; onOpenGuide?: () => void; detailed?: boolean; currentVersion?: string; accountScope?: string } = {}) {
